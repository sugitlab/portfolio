import { twitter_en } from "../lib/constants";
...
const en = {
  ...
  PROFILE_1_HEAD: "Software Engineer, Country Life",
  PROFILE_1:
    "Japanese living in Japan, sooo normal. I'm living in the SHIGA prefecture (next to Kyoto). There are beautiful rivers, mountains and lakes, and more 4 starbucks also available by walk. That means, Incredibly comfortable. wow.",
  PROFILE_2_HEAD: "App",
  PROFILE_2:
